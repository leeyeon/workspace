...
//		HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
	...
	public static void addUserTest_CodeHaus() throws Exception {
		...
		JSONObject json = new JSONObject();
		json.put("userId", "testRest");
		json.put("userName", "testRest");
		json.put("password", "1234");
		HttpEntity httpEntity01 = new StringEntity(json.toString(),"utf-8");
	...
	public static void listUserTest_CodeHaus() throws Exception {
		...
		List<User> list = objectMapper.readValue(jsonobj.get("list").toString(), 
	...
	public static HttpRequestBase getRequestMethod(String method, String url) {
